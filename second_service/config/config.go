...
func Load() Config {
	...
	config.ServiceName = cast.ToString(getOrReturnDefaultValue("SERVICE_NAME", "Second_Service"))
	...
	config.GRPCPort = cast.ToString(getOrReturnDefaultValue("GRPC_PORT", ":9002"))
